...
// Perception via opencode Plugin SDK: event hook → HTTP POST to WangPet
...
module.exports = {
  ...
  // wang-pet-internal event names (PascalCase) — opencode-plugin/index.mjs translates
  ...
  capabilities: {
    ...
    permissionApproval: true, // Phase 2: WangPet bubble → opencode REST reply
    sessionEnd: true,
