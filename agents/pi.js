...
// Perception via Pi extension: lifecycle event hook -> HTTP POST to WangPet.
// Pi remains state-only here; WangPet must not add a permission layer on top of
...
module.exports = {
  ...
  // wang-pet-internal event names. hooks/pi-extension-core.js translates Pi's
