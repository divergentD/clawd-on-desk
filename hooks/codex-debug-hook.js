...
//
// This hook intentionally does not talk to WangPet's runtime server and writes
...
const DEFAULT_LOG_PATH = path.join(os.homedir(), ".wang-pet", "codex-hook-debug.jsonl");
...
function appendDebugEntry(entry, logPath = process.env.WANGPET_CODEX_DEBUG_LOG || DEFAULT_LOG_PATH) {
