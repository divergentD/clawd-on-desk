 ...
 *
 * Strict mode throws on missing/invalid; lenient falls back to "wang-pet".
...
function loadTheme(themeId, opts = {}) {
  ...
  if (!raw) {
    ...
    if (themeId !== "wang-pet") return loadTheme("wang-pet");
    throw new Error("Default theme 'wang-pet' not found");
  }
