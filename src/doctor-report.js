...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# WangPet Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- WangPet version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. WangPet does not upload any data. User paths are replaced with `~`, and WangPet app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
