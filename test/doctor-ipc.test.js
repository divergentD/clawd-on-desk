...
describe("Doctor IPC helpers", () => {
  ...
  it("normalizes doctor:open-wang-pet-log payloads to string names only", () => {
    ...
    assert.deepStrictEqual(__test.normalizeDoctorOpenLogPayload({ name: "WangPet.log" }), { name: "WangPet.log" });
  });
});
