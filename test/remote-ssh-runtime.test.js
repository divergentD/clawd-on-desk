...
test("buildProbeCommand embeds remoteForwardPort + WangPet header check", () => {
  ...
  assert.ok(cmd.includes(WANGPET_SERVER_HEADER));
  assert.ok(cmd.includes(WANGPET_SERVER_ID));
